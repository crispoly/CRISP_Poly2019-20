...
//Assign the modbus device ID.  
  regBank.setId(1);          // LE SLAVE ID EST ICI!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  pinMode(5,INPUT);
  pinMode(13,OUTPUT);
...
//Add Digital Output registers 00001-00016 to the register bank
  ...
  //regBank.add(2);
  regBank.add(3);
  regBank.add(4);       //J'AJOUTER LE DIGITAL PIN 4
//  regBank.add(5);
  regBank.add(6);
  regBank.add(7);
  regBank.add(8);
...
//  regBank.add(10003);  
//  regBank.add(10004);  
  regBank.add(10005);      //J'AJOUTE LE DIGITAL PIN 5
//  regBank.add(10006);  
//  regBank.add(10007);  
//  regBank.add(10008);  
...
//Add Analog Input registers 30001-30010 to the register bank
//  regBank.add(30001);  
//  regBank.add(30002);  
//  regBank.add(30003);  
//  regBank.add(30004);  
...
//  regBank.set(2, 1);  
  regBank.set(3, 0);  
  regBank.set(4, 1);                                                      //TRES IMPORTANT ICI; JE SET LE DIGITAL PIN 4 A HIGH
//  regBank.set(5, 1);  
  regBank.set(6, 0);  
  regBank.set(7, 1);  
  regBank.set(8, 0);  
