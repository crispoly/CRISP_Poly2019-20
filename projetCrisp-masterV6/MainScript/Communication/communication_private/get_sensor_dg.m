...
switch name
    ...
    case 'vit_1'
        dg = create_dg(2, 6, 3, 0, 0);
    case 'vit_2'
        dg = create_dg(3, 6, 3, 0, 0);
    case 'vit_3'
        dg = create_dg(4, 6, 3, 0, 0);
    case 'vit_4'
        dg = create_dg(5, 6, 3, 0, 0);
    case 'vit_5'
        dg = create_dg(6, 6, 3, 0, 0);
    case 'vit_6'
        dg = create_dg(7, 6, 3, 0, 0);
    case 'acc_1'
        dg = create_dg(2, 6, 11, 0, 0);
    case 'acc_2'
        dg = create_dg(3, 6, 11, 0, 0);
    case 'acc_3'
        dg = create_dg(4, 6, 11, 0, 0);
    case 'acc_4'
        dg = create_dg(5, 6, 11, 0, 0);
    case 'acc_5'
        dg = create_dg(6, 6, 11, 0, 0);
    case 'acc_6'
        dg = create_dg(7, 6, 11, 0, 0);
    case 'tl_1'
